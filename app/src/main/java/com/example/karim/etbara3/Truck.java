...
public class Truck extends AppCompatActivity {
    ...
    String date = "", currdate = "", description="";
    ...
    public void request(View view) {
        ...
        else
        {
            ...
            String url = "http://46.101.108.112/etbara3/requesttruck.php";
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if (status == 1) {
                                    ...
                                    final Intent intent = new Intent(Truck.this, MainActivity.class);
    ...
    {
        DatePickerDialog dialog = new DatePickerDialog(Truck.this, datePickerListener, mYear, mMonth, mDay);
        dialog.show();
    }
